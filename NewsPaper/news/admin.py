...
class PostAdmin(admin.ModelAdmin):
    list_display = ('name', 'author_post', 'date_pub', 'content_rate')
    ordering = ['-date_pub']
...
class CommentsAdmin(admin.ModelAdmin):
    list_display = ('comments', 'post', 'user', 'date_comment', 'comment_rate')
    ...
    fieldsets = [
        ...
        ('Информация о комментарии', {'fields': ['user', 'date_comment', 'post', 'comment_rate']}),
    ]
